...
private:
	...
	// Biến để theo dõi trạng thái kết nối lại
	bool bReconnecting;  // Kiểm tra xem có đang trong quá trình kết nối lại
	int reconnectAttempts;  // Số lần thử kết nối lại
	...
	/* Frunnable Helper. */
	bool                        bRunning;
	static std::unique_ptr<KinectDevice>        Instance;
	...
	// Phương thức kiểm tra kết nối và thử kết nối lại
